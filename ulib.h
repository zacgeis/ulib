...
#define u_array_getv(type, arr, i) (* ((type *) _u_array_get(arr, i)))
#define u_array_getp(type, arr, i) ((type *) _u_array_get(arr, i))
...
#define u_queue_peekv(type, arr) (* ((type *) _u_queue_peek(queue)))
#define u_queue_peekp(type, arr) ((type *) _u_queue_peek(queue))
void u_queue_remove(u_queue_t *queue);

// LIST

typedef u_list_node_t u_list_node_t;
...
void u_list_prepend(u_list_t *list, void *value);
void u_list_append(u_list_t *list, void *value);
...
u_list_node_t *u_list_node_next(u_list_node_t *current);
u_list_node_t *u_list_node_prev(u_list_node_t *current);
